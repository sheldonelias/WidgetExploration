package com.example.widgetexplorationtextbook;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Store all widgets as declared and initialized variables
        ...
        */
        ...
        // Implements anonymous class from CompoundButton interface
        //
        cbTransparency.setOnCheckedChangeListener(
              ...
              //With two methods, cannot convert to a lambda expression
              public void exampleSecondMethod()
              {
                  String msg  = "exampleSecondMethod() active";
